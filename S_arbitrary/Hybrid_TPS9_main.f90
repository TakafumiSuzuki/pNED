...
logical :: fread=.true.
integer :: pme, pnp, i_color, o_np, q1, q2, lsize, lrange, nrnd
...
!!
call get_cline(d1=sim_time,d2=q_spin,d3=lsize,d4=lrange,d5=pm,d6=o_np,d7=typ,d8=q1,d9=q2,d10=nrnd)
!!
call my_mpi_start()
!!
call init_timer
...
call timer_start(1)
!!
call bcast_sim_data(num_threads,o_np,sim_time,lsize,lrange,q1,q2,pm,typ,q_spin,nrnd)
